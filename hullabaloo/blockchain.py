...
class Blockchain(object):
    def __init__(self):
        ...
        self.target = "0000fffffffffffffffffffffffffffffff" + \
    ...
    @staticmethod
    def create_block(height, transactions, previous_hash,
                     nonce, target, timestamp=None):
        block = {
            "height": height,
    ...
    def recalculate_target(self, block_index):
        ...
        if block_index % 10 == 0:
            ...
            # Calculate the new target by multiplying the current 
            # one by the ratio
